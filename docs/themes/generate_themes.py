...
THEMES = [
    ...
    dict(slug="lunarcore", label="Lunarcore", icon="⏾", scheme="dark",
         ...
         muted="#9fb2cc", faint="#6c809e", border="#24344d", border_subtle="#141f30",
    ...
    dict(slug="cloud", label="Cloud", icon="☁", scheme="light", font=ROUND,
         ...
         muted="#56657a", faint="#5d6c83", border="#cad4e2", border_subtle="#dce3ec",
         accent="#5369a8", accent_hover="#43568f", code="#3c6e71"),
    # ---- Retro computing --------------------------------------------------
    dict(slug="gameboy", label="Game Boy", icon="▣", scheme="dark", font=MONO,
         bg="#0f2818", surface="#163420", text="#9bbc0f",
         muted="#87a80e", faint="#80a10e", border="#306230", border_subtle="#22461f",
    ...
    dict(slug="c64", label="Commodore", icon="▩", scheme="dark", font=MONO,
         ...
         muted="#9d90ee", faint="#9a8fde", border="#4a3fa0", border_subtle="#362c85",
    ...
    dict(slug="nes", label="8-Bit", icon="✜", scheme="dark", font=MONO,
         ...
         muted="#a6a6c8", faint="#7d7dac", border="#38386a", border_subtle="#202040",
    ...
    dict(slug="solarized", label="Solarized", icon="◉", scheme="dark", font=MONO,
         ...
         muted="#8b9ba0", faint="#8a9ba1", border="#0a4b5a", border_subtle="#073642",
         accent="#2ca99f", accent_hover="#4cc2b9", code="#8da200"),
    ...
    dict(slug="blueprint", label="Blueprint", icon="⊟", scheme="dark", font=MONO,
         ...
         muted="#bcd6ef", faint="#96bade", border="#2f6ba0", border_subtle="#1a5286",
