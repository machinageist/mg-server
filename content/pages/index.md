...
**OSINT:**
[mg-github](/wiki/mg-github), [mg-breach](/wiki/mg-breach), [mg-social](/wiki/mg-social), [mg-metadata](/wiki/mg-metadata), [mg-google-dork](/wiki/mg-google-dork), [mg-leak-monitor](/wiki/mg-leak-monitor)
...
**Auth and session:**
[mg-jwt](/wiki/mg-jwt), [mg-authz](/wiki/mg-authz), [mg-oauth](/wiki/mg-oauth), [mg-session-audit](/wiki/mg-session-audit), [mg-apikey](/wiki/mg-apikey), [mg-brute](/wiki/mg-brute)
...
[mg-apk](/wiki/mg-apk), [mg-ipa](/wiki/mg-ipa), [mg-js-analyze](/wiki/mg-js-analyze), [mg-sourcemap](/wiki/mg-sourcemap), [mg-secret-validate](/wiki/mg-secret-validate), [mg-csp](/wiki/mg-csp)
...
for crate in subdomain-enum mg-scan fingerprint mg-recon corpus-builder \
             ...
             mg-github mg-breach mg-social mg-metadata mg-google-dork \
             ...
             mg-oauth mg-session-audit mg-apikey mg-brute mg-ssrf mg-oob \
             ...
             mg-websocket mg-apk mg-ipa mg-js-analyze mg-sourcemap \
...
A multi-stage `Dockerfile` ships all 83 workspace binaries in one
